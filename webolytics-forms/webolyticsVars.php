...
$labelPublished = array();
$labelPublished['published'] = 'success';
$labelPublished['published_hex'] = '#7cb342';
$labelPublished['published_hex_half'] = '#dcedc8';
$labelPublished['published_hex_75'] = '#aed581';
$labelPublished['published_bg'] = 'light-green-100';
$labelPublished['awaiting_published_bg'] = 'light-blue-50';
$labelPublished['awaiting_published'] = 'primary';
$labelPublished['awaiting_published_hex'] = '#2196f3';
$labelPublished['awaiting_published_hex_half'] = '#e1f5fe';
$labelPublished['awaiting_published_rgb_half'] = '225, 245, 254';
$labelPublished['awaiting_published_hex_75'] = '#4fc3f7';
$labelPublished['not_published'] = 'danger';
$labelPublished['not_published_bg'] = 'red-100';
$labelPublished['not_published_hex'] = '#e53935';
$labelPublished['not_published_hex_half'] = '#ffcdd2';
$labelPublished['not_published_hex_75'] = '#ef9a9a';
$labelPublished['pending_published'] = 'warning';
$labelPublished['pending_published_bg'] = 'orange-100';
$labelPublished['pending_published_hex'] = '#ffa000';
$labelPublished['pending_published_hex_half'] = '#ffe0b2';
$labelPublished['pending_published_hex_75'] = '#ffcc80';
$labelPublished['verify'] = 'warning';
$labelPublished['primary_bg'] = 'blue-100';
$labelPublished['text-success'] = 'md-color-light-green-500'; 
$labelPublished['text-primary'] = 'md-color-blue-500'; 
$labelPublished['text-danger'] = 'md-color-red-500'; 
$labelPublished['text-notification'] = 'md-color-orange-500'; 
$labelPublished['muted_hex'] = '#eee'; 

$labelIcon=array();
$labelIcon['pw'] = 'lock';
$labelIcon['social'] = 'perm_contact_calendar';
$labelIcon['phone'] = 'call';
$labelIcon['email'] = 'email';
$labelIcon['text_field'] = 'text_format';
$labelIcon['text_area'] = 'subject';
$labelIcon['date_field'] = 'event_available';
$labelIcon['password_field'] = $labelIcon['pw'];
$labelIcon['select_field'] = 'list';
$labelIcon['radio_field'] = 'radio_button_checked';
$labelIcon['checkbox_field'] = 'check_box';
$labelIcon['address'] = 'place';
$labelIcon['name'] = 'person';
$labelIcon['vendor'] = 'business';
$labelIcon['users'] = 'folder_shared';
//$labelIcon['view'] = 'touch_app';
$labelIcon['view'] = 'visibility';
$labelIcon['preview'] = 'visibility';
$labelIcon['delete_forever'] = 'delete_forever';
$labelIcon['delete'] = 'delete';
$labelIcon['edit'] = 'edit';
$labelIcon['add'] = 'add_box';
$labelIcon['alert'] = 'report_problem';
$labelIcon['admin_section'] = 'build';
$labelIcon['dashboard_section'] = 'developer_board';
$labelIcon['dashboard_portal_section'] = '&#xE871;';
$labelIcon['form_builder'] = 'rate_review';
$labelIcon['up'] = 'keyboard_arrow_up';
$labelIcon['down'] = 'keyboard_arrow_down';
$labelIcon['prev'] = 'keyboard_arrow_left';
$labelIcon['next'] = 'keyboard_arrow_right';
$labelIcon['free_text'] = 'format_align_left';
$labelIcon['campaigns'] = 'multiline_chart';
$labelIcon['monetisation'] = 'show_chart';
$labelIcon['clickthrough'] = 'keyboard_tab';
$labelIcon['map_data'] = 'call_merge';
$labelIcon['acquisitions'] = 'supervisor_account';
$labelIcon['notification'] = 'report_problem';
$labelIcon['roles'] = 'enhanced_encryption';
$labelIcon['sub_roles'] = 'lock';
$labelIcon['options'] = '&#xE5D4;';
$labelIcon['expand'] = '&#xE5D0;';
$labelIcon['modules'] = 'settings_input_component';
$labelIcon['published_setting'] = 'pan_tool';
$labelIcon['countries'] = 'public';
$labelIcon['url_referer'] = 'call_made';
$labelIcon['url_referer_host'] = 'call_made';
$labelIcon['url_referer_path'] = 'subdirectory_arrow_right';
$labelIcon['url_referer_variable'] = 'call_missed_outgoing';
$labelIcon['url'] = 'call_received';
$labelIcon['url_host'] = 'call_received';
$labelIcon['url_path'] = 'subdirectory_arrow_left';
$labelIcon['url_variable'] = 'call_missed';
$labelIcon['ip'] = 'linear_scale';
$labelIcon['browser'] = 'cast';
$labelIcon['device'] = 'devices_other';
$labelIcon['city'] = 'location_city';
$labelIcon['timezone'] = 'language';
$labelIcon['lat_long'] = 'pin_drop';
$labelIcon['network_provider'] = 'network_wifi';
$labelIcon['hidden'] = 'visibility_off';
$labelIcon['handle'] = '&#xE5D2';
$labelIcon['api'] = 'device_hub';
$labelIcon['iframe'] = 'tab_unselected';
$labelIcon['download'] = 'get_app';
$labelIcon['colours'] = 'color_lens';
$labelIcon['email_settings'] = 'send';
$labelIcon['test'] = 'flash_on';
$labelIcon['risk_management'] = 'security';
$labelIcon['authentication'] = 'fingerprint';
$labelIcon['api'] = 'device_hub';
$labelIcon['legals'] = 'gavel';
$labelIcon['cycle'] = 'alarm';
$labelIcon['check'] = 'done';
$labelIcon['check_done'] = 'done_all';
$labelIcon['toggle'] = 'swap_horiz';
$labelIcon['copy'] = 'add_to_photos';
$labelIcon['vendor_tax'] = 'assignment';
$labelIcon['bank_details'] = 'account_balance';
$labelIcon['conversion_snippet']='settings_input_antenna';
